...
function DBCards() {
  return (
    <>
    <div className='xl:min-w-80 w-auto h-40 px-4 flex rounded-md border shadow-lg  mr-4 hover:-translate-x-1 hover:-translate-y-1 cursor-pointer transition-all'>
