...
function DBCards() {
  return (
    <>
    <div className='lg:w-80 h-40 px-4 flex rounded-md border shadow-lg lg:mr-10'>
        <div className='w-full flex'>
            ...
            <div className='h-full flex items-center justify-end'>
                <div className='p-3 rounded-full bg-primary bg-opacity-10'>
                     <svg xmlns="http://www.w3.org/2000/svg" className="h-14 w-14 text-primary" viewBox="0 0 20 20" fill="currentColor">
        ...
        <div className='w-full flex'>
            ...
            <div className='h-full flex items-center justify-end'>
                <div className='p-3 rounded-full bg-orange-600 bg-opacity-20'>
                    <svg xmlns="http://www.w3.org/2000/svg" className="h-14 w-14 text-orange-600" viewBox="0 0 20 20" fill="currentColor">
        ...
        <div className='w-full flex'>
            ...
            <div className='h-full flex items-center justify-end'>
                <div className='p-3 rounded-full bg-pink-600 bg-opacity-20'>
                    <svg xmlns="http://www.w3.org/2000/svg" className="h-14 w-14 text-pink-600 " viewBox="0 0 20 20" fill="currentColor">
