    ...
    <div className='w-full h-12 bg-gray-300'>
        <div className='w-full h-full flex justify-between'>
            ...
            <div className='h-full flex mr-4 items-center static'>
                <input type="text" name="search" id="" className='h-8 md:w-80 py-4 px-10 text-sm border-2 rounded-full border-slate-300 bg-white' placeholder='search for anything...' />
