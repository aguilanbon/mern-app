...
function TopBar() {
    ...
    const { setSideNavOpen } = useContext(GlobalHelperContext)

    return (
        <div className='w-full h-12 mb-4'>
            <div className='w-auto h-full flex justify-between'>
                <div className='h-full flex justify-center items-center ml-4 cursor-pointer' onClick={() => setSideNavOpen(prev => !prev)}>
